...
--insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (2, 'Thai Delivery', 8.5, 1, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro');
